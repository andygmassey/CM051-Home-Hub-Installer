...
MSG_INFO_APPLE_MAIL_DOES_NOT_APPEAR_HOLD="Apple Mail non sembra contenere ancora messaggi locali. Doctor mostrerà un promemoria se non arriva posta entro 24 ore."
MSG_INFO_APPLE_MAIL_HAS_CACHED_MESSAGES_INGEST="Apple Mail ha messaggi in cache. L'acquisizione li recupererà al prossimo ciclo orario."
MSG_INFO_APPLE_MAIL_NO_CONTENT_CONNECT_ACCOUNT="Apple Mail è selezionato, ma su questo Mac non ci sono ancora messaggi locali da leggere. Apri Apple Mail e aggiungi un account (Impostazioni di Sistema > Account Internet, poi spunta Mail) e lascia che completi una prima sincronizzazione."
MSG_INFO_APPLE_MAIL_NO_CONTENT_RERUN="Una volta arrivata la posta, riesegui: ostler-fda. Ostler la recupererà automaticamente; non serve altro."
MSG_INFO_APPLE_NOTARISATION_WILL_VERIFIED_GATEKEEPER_FIRST="La notarizzazione Apple verrà verificata da Gatekeeper al primo avvio."
MSG_INFO_AVAILABLE_INSTALLER_WILL_SKIP_THIS_STEP="disponibile, l'installer salterà automaticamente questo passaggio."
...
MSG_INFO_CM042_INTEL_NOT_SUPPORTED_SKIPPING="Ostler RemoteCapture è solo per Apple Silicon. Installazione saltata su questa macchina."
MSG_INFO_CM042_LOGS_AT="Log di RemoteCapture: %s/ostler-remotecapture.log (e .err)"
MSG_INFO_CM042_TCC_PRE_PROMPT="Al primo avvio, Ostler RemoteCapture chiederà a macOS il permesso di Registrazione Schermo e Microfono. Concedi entrambi così chiamate e riunioni possono essere trascritte localmente. Nessun indicatore viola di registrazione appare nella barra dei menu: la cattura audio è silenziosa per scelta progettuale."
...
MSG_OK_HUB_APP_PRESENT="Ostler.app già presente in %s; firma verificata."
MSG_OK_HUB_APP_STAGED="Ostler.app installato in %s"
MSG_WARN_HUB_APP_NOT_FOUND="Ostler.app non è stato trovato in /Applications e non è disponibile alcuna copia in bundle."
MSG_WARN_HUB_APP_VERIFY_FAILED="La verifica della firma o della notarizzazione di Ostler.app non è riuscita. Il bundle resta al suo posto così l'assistenza può esaminarlo."
...
MSG_INFO_COLIMA_INSTALLED_BUT_NOT_RUNNING_WILL="Colima è installato ma non in esecuzione. Verrà avviato."
MSG_INFO_COLIMA_START_ATTEMPT="Avvio di Colima (tentativo %s di %s)..."
MSG_INFO_COULD_NOT_EXPORT_CONTACTS_YOU_CAN="Impossibile esportare i contatti. Puoi importarli manualmente più tardi."
MSG_INFO_COULD_NOT_READ_CONTACT_CARD_NO="Impossibile leggere la scheda contatto. Nessun problema: te lo chiederemo invece."
MSG_INFO_CONTACT_CARD_WILL_ASK="Tra poco ti chiederemo nome e paese. I tuoi contatti vengono letti più tardi usando l'accesso a Tutto il Disco che concedi, e nulla lascia questo Mac."
...
MSG_WARN_EMAIL_INGEST_SCRIPTS_NOT_BUNDLED_PLAINTEXT="Script di acquisizione email non inclusi ed è stato passato --allow-plaintext; l'installazione del LaunchAgent verrà saltata. Le email future non verranno scaricate."
MSG_INFO_EXISTING_CHECKOUT_UPDATING="  Checkout esistente in %s; aggiornamento..."
MSG_INFO_EXTRACTING_GMAIL_MBOX_FROM_TAKEOUT_ZIP="Estrazione della mbox di Gmail dallo zip di Takeout (per archivi grandi può richiedere un minuto)..."
...
MSG_INFO_GDPR_EXPORTS_DETECTED_BUT_IMPORT_PIPELINE="Export GDPR rilevati ma la pipeline di importazione non è ancora disponibile."
MSG_INFO_GDPR_EXPORT_IMPORT_WILL_AVAILABLE_WHEN="L'importazione degli export GDPR sarà disponibile quando la pipeline verrà rilasciata."
MSG_INFO_GDPR_SCAN_PROMPTS_INCOMING="Sto per analizzare Download, Scrivania e Documenti alla ricerca di export di IA (Google Takeout, download di Meta, LinkedIn, ecc.) che potresti aver salvato. macOS mostrerà tre richieste di accesso alle cartelle: concedile tutte. Richiede circa 5-10 secondi in totale. Nulla viene spostato o copiato durante la scansione; controlliamo solo cosa c'è."
MSG_INFO_CALENDAR_PERMISSION_PREWARM="macOS potrebbe chiedere il permesso di leggere il tuo Calendario. Concedilo così Ostler può costruire la parte di riunioni ed eventi del tuo grafo di conoscenza. (I dati del calendario restano su questa macchina.)"
...
MSG_INFO_GIT_NOT_FOUND_INSTALLING_XCODE_COMMAND="Servono gli Xcode Command Line Tools. macOS chiederà il permesso di installarli: cerca una piccola finestra grigia (se non la vedi, premi Cmd+Tab o controlla il Dock). Clicca Installa. Gli strumenti vengono scaricati in background mentre rispondi alle domande qui sotto."
MSG_INFO_CLT_STILL_INSTALLING_ELAPSED="  Configurazione delle Command Line Tools ancora in corso (%ss). Se una piccola finestra di dialogo grigia di macOS chiede di installare gli strumenti per sviluppatori, fai clic su Installa – questo passaggio sta aspettando proprio quello. (Cmd+Tab o controlla il Dock se non la vedi.)"
...
MSG_INFO_OPENING_TAILSCALE_FOR_SIGNIN="Apertura di Tailscale così puoi accedere..."
MSG_INFO_TAILSCALE_SKIPPED="Tailscale saltato: l'iOS Companion funzionerà solo sul tuo Wi-Fi di casa. Puoi configurarlo più tardi dalle Impostazioni."
...
MSG_INFO_IMESSAGE_FDA_ASSIST_STILL_NEEDED="Il Full Disk Access è ancora in attesa. La dashboard Doctor terrà visibile la scheda finché l'accesso non viene concesso."
MSG_INFO_IMESSAGE_FDA_DAEMON_TCC_GRANTED="ostler-assistant ha già il Full Disk Access; non serve altro."
MSG_INFO_IMESSAGE_FDA_PROBE_BEGIN="Verifica se l'assistente Ostler può leggere la cronologia di Messages..."
MSG_INFO_IMESSAGE_FDA_PROBE_GRANTED="L'assistente può leggere la cronologia di Messages; il canale iMessage funzionerà."
MSG_INFO_IMESSAGE_FDA_PROBE_NEEDS_GRANT="L'assistente non può ancora leggere la cronologia di Messages. La dashboard Doctor mostrerà una scheda che ti guidera attraverso Impostazioni di Sistema."
MSG_INFO_IMESSAGE_FDA_PROBE_SKIPPED_NO_DAEMON="Il LaunchAgent dell'assistente non si è caricato; verifica del Full Disk Access per iMessage saltata."
MSG_INFO_IMPORT_EVERNOTE_UI_DOCTOR_WILL_SURFACE="L'interfaccia Importa-Evernote in Doctor mostrerà un 'servizio non disponibile'"
...
MSG_INFO_INTEL_SUPPORT_NOT_ROADMAP_RAISE_REQUEST="Il supporto Intel non è in roadmap; apri una richiesta se necessario."
...
MSG_INFO_LATER_SYSTEM_SETTINGS_PRIVACY_SECURITY_FULL="più tardi in Impostazioni di Sistema > Privacy e Sicurezza > Full Disk Access"
MSG_INFO_LAUNCH_VERIFY_CRON_DELIVERY_IMESSAGE_TCC="  avvio per verificare lo stato di cron-delivery + imessage-tcc)."
MSG_INFO_LICENCE_APACHE_2_0_FULL_TEXT="Licenza: %s è Apache 2.0. Testo completo: %s/LICENSES/Apache-2.0.txt"
...
MSG_INFO_MESSAGE_WHEN_FEATURE_FLAG_LATER_FLIPPED="messaggio quando il feature flag verrà attivato più tardi."
...
MSG_INFO_NO_CHANNELS_CONFIGURED_RUN_LATER_BIN="Nessun canale configurato. Esegui più tardi: %s/bin/ostler-assistant setup channels --interactive"
...
MSG_INFO_OSTLER_WILL_SHOW_EXTRA_CONSENT_SCREEN="      Ostler mostrerà una schermata di consenso aggiuntiva prima di installare"
...
MSG_INFO_PULLING_THIS_MAY_TAKE_FEW_MINUTES="Download di %s (%s)... può richiedere alcuni minuti."
...
MSG_INFO_RECOVERY_PASSPHRASE_INTRO="Ora scegli la passphrase che sbloccerà il tuo Hub. La digiterai ogni volta che avvii l'interfaccia dell'Hub."
...
MSG_INFO_SKIPPED_CONVERSATION_MODEL_PULL_LATER_OLLAMA="Modello di conversazione saltato. Scaricalo più tardi: ollama pull %s"
...
MSG_INFO_THIS_EXPECTED_NOW_GDPR_IMPORT_WILL="Per ora è previsto. L'importazione GDPR sarà disponibile in un aggiornamento futuro."
# TODO(i18n): reworded in en-GB (#596/#573) -- needs human re-translation;
# en-GB text used until then so the install-time expectations stay honest.
...
MSG_INFO_TO_INSTALL_LATER_ONCE_YOU_HAVE="Per installare più tardi, una volta ottenuto l'accesso:"
...
MSG_INFO_USER_FACING_TREE_ALREADY_ANNOUNCED_SENTINEL="Albero per l'utente già annunciato (sentinella presente); saltato"
...
MSG_INFO_VOICE_RECOGNITION_WILL_STAY_OFF_YOU="Il riconoscimento vocale restera disattivato. Puoi attivarlo più tardi nelle Impostazioni."
MSG_INFO_WAITING_YOU_SIGN_TAILSCALE_UP_3="Attesa che tu acceda a Tailscale (fino a 3 minuti)..."
MSG_INFO_WHATSAPP_CONNECTOR_LEFT_OFF_YOU_CAN="Connettore WhatsApp lasciato disattivato. Puoi attivarlo più tardi dalle Impostazioni."
...
MSG_INFO_WIKI_RECOMPILE_CATCHUP_SKIPPED_NO_TICK="Recupero del wiki del primo giorno saltato: il ciclo di ricompilazione del wiki non è installato. La ricostruzione giornaliera del wiki, se installata, viene comunque eseguita."
MSG_INFO_WIKI_RECOMPILE_SCRIPTS_NOT_BUNDLED_WITH="Script di ricompilazione del wiki non inclusi nell'installer."
MSG_INFO_WIKI_WILL_NOT_AUTO_UPDATE_YOU="Il wiki non si aggiornerà automaticamente; puoi rieseguire la prima compilazione manualmente:"
MSG_INFO_WROTE_POSTURE_MARKER_INSTALL_JSON="Marker di stato scritto: %s/install.json"
MSG_INFO_YOUR_EXPORTS_ARE_SAFE_IMPORT_THEM="I tuoi export sono al sicuro. Importali più tardi con: ostler-import %s"
MSG_INFO_YOUR_MAC_DATA_IMESSAGE_SAFARI_ETC="I tuoi dati Mac (iMessage, Safari, ecc.) sono già stati estratti sopra."
MSG_INFO_YOU_CAN_ADD_IT_LATER_INSTANT="Puoi aggiungerlo più tardi per un onboarding istantaneo da Safari, iMessage, ecc."
...
MSG_OK_ALREADY_AVAILABLE="%s già disponibile"
...
MSG_OK_APP_DATABASES_ALREADY_PRESENT_SKIPPING_PRE="Database delle app già presenti (pre-avvio saltato)"
...
MSG_OK_DATABASES_ENCRYPTED_PASSPHRASE_REQUIRED_EACH_STARTUP="Database cifrati. La passphrase è richiesta a ogni avvio."
MSG_OK_DEFERRED_DEVICE_REGISTRATION_RETRY_INSTALLED_RUNS="Ritentativo differito di registrazione dispositivo installato (viene eseguito ogni ora finché la coda non si svuota)"
...
MSG_WARN_WHATSAPP_SOURCE_FAILED="Installazione del lettore di conversazioni WhatsApp non riuscita; il feed delle conversazioni WhatsApp non verrà eseguito. Vedi l'output sopra."
...
MSG_WARN_WHATSAPP_BUNDLE_VENDOR_MISSING="Pacchetto del feed delle conversazioni WhatsApp non trovato in questo installer; saltato. La cronologia dei messaggi WhatsApp (a chi hai scritto e quando) non è interessata."
...
MSG_WARN_WHATSAPP_BUNDLE_FAILED="Installazione del LaunchAgent del feed delle conversazioni WhatsApp non riuscita. Vedi l'output sopra; il resto dell'installazione non è interessato."
...
MSG_WARN_EMAIL_SOURCE_FAILED="Installazione del lettore di conversazioni email non riuscita; il feed delle conversazioni email non verrà eseguito. Vedi l'output sopra."
...
MSG_WARN_EMAIL_BUNDLE_VENDOR_MISSING="Pacchetto del feed delle conversazioni email non trovato in questo installer; saltato. L'acquisizione oraria delle email non è interessata."
...
MSG_WARN_EMAIL_BUNDLE_FAILED="Installazione del LaunchAgent del feed delle conversazioni email non riuscita. Vedi l'output sopra; il resto dell'installazione non è interessato."
...
MSG_WARN_SPOKEN_SOURCE_FAILED="Installazione del lettore di conversazioni di riunioni e voce non riuscita; il feed non verrà eseguito. Vedi l'output sopra."
...
MSG_WARN_SPOKEN_BUNDLE_FAILED="Installazione del LaunchAgent del feed delle conversazioni di riunioni e voce non riuscita. Vedi l'output sopra; il resto dell'installazione non è interessato."
...
MSG_WARN_IMESSAGE_SOURCE_FAILED="Installazione del lettore di conversazioni iMessage non riuscita; il feed delle conversazioni iMessage non verrà eseguito. Vedi l'output sopra."
...
MSG_WARN_IMESSAGE_BUNDLE_FAILED="Installazione del LaunchAgent del feed delle conversazioni iMessage non riuscita. Vedi l'output sopra; il resto dell'installazione non è interessato."
...
MSG_OK_MAIL_OPENING_INTERNET_ACCOUNTS="Apertura di Impostazioni di Sistema > Account Internet così puoi aggiungere un account di posta. Torna a questa finestra una volta effettuato l'accesso al tuo primo account."
MSG_OK_MAIL_SKIPPING_INTERNET_ACCOUNTS="Passaggio Account Internet saltato. Puoi aggiungere un account di posta più tardi da Impostazioni di Sistema; Doctor mostrerà un promemoria se non arriva posta entro 24 ore."
MSG_OK_MAIL_EXTENDING_FULL_HISTORY="Recupero ora dell'intera cronologia di Apple Mail. Per una casella grande può richiedere un po' più di tempo."
MSG_OK_MAIL_KEEPING_DEFAULT_HISTORY="Mantengo la finestra standard di cinque anni di posta. Puoi recuperarne altra più tardi da Doctor."
MSG_OK_NOMIC_EMBED_TEXT_ALREADY_AVAILABLE="nomic-embed-text già disponibile"
...
MSG_OK_SECURITY_ALREADY_CONFIGURED_PREVIOUS_RUN="Sicurezza già configurata in un'esecuzione precedente."
...
MSG_WARN_QDRANT_COLLECTION_PRECREATE_FAILED="Impossibile preparare la collezione di ricerca %s; il wiki verrà comunque costruito (il lettore la tratta come vuota)"
MSG_WARN_QDRANT_NOT_READY_COLLECTIONS_SKIPPED="Indice di ricerca non pronto in tempo; preparazione delle collezioni opzionali saltata (il wiki verrà comunque costruito)"
...
MSG_OK_TAILSCALE_ALREADY_INSTALLED="Tailscale già installato"
MSG_OK_TAILSCALE_INSTALLED="Tailscale installato"
MSG_OK_TAILSCALE_ENV_PERSISTED="IP di Tailscale salvato in .env: l'iOS Companion lo userà al primo avvio."
...
MSG_WARN_TAILSCALED_USERSPACE_START_FAILED="Impossibile avviare il servizio in background di Tailscale. Puoi rieseguire la configurazione più tardi dalle Impostazioni."
...
MSG_OK_WHATSAPP_CONNECTOR_WILL_ENABLED_CONSENT_RECORDED="Il connettore WhatsApp verrà abilitato (consenso registrato)"
...
MSG_INFO_WIKI_BACKGROUND_SUMMARIES_STARTED="Il tuo wiki è pronto da consultare. Ostler sta ora scrivendo i riepiloghi delle pagine in background, quindi si riempiranno nel giro di poco. Puoi iniziare a usare il tuo wiki subito."
...
MSG_WARN_CONTEXT_REFRESH_LAUNCHAGENT_FAILED="Il LaunchAgent del digest del contesto personale non si è caricato; vedi context-refresh.err. L'assistente risponde comunque tramite ricerche in tempo reale"

# ── Warnings (non-fatal) ──

MSG_WARN_BASH_INSTALL_SNIPPET_SH="  bash %s/INSTALL_SNIPPET.sh"
MSG_WARN_BLOCK_3_1_CM024_PRODUCTISATION_STACK="Alla sorgente clonata del servizio Knowledge manca la configurazione di packaging, quindi il suo ambiente non è stato configurato."
MSG_WARN_BUNDLE="  Bundle: %s"
MSG_WARN_CD="  cd %s"
MSG_WARN_CD_2="    cd %s"
MSG_WARN_CM042_APPLE_SILICON_ONLY="Ostler RemoteCapture v%s è solo per Apple Silicon (rilevato: %s)."
MSG_WARN_CM042_DOWNLOAD_FAILED="Impossibile scaricare Ostler RemoteCapture v%s da %s"
MSG_WARN_CM042_DOWNLOAD_NEXT_STEPS="Cause comuni: tag della release non ancora pubblicato, rete offline, o notarizzazione upstream ancora in corso. Riesegui l'installer quando la release è attiva."
...
MSG_WARN_CM048_PIPELINE_CONVERSATION_ENRICHMENT_UNAVAILABLE="  L'arricchimento delle conversazioni non sarà disponibile. Il resto di Ostler si installa normalmente; riesegui senza --allow-plaintext per collegare il motore della memoria delle conversazioni."
...
MSG_WARN_CM048_PIPELINE_MISSING_FROM_APP_BUNDLE="  Di solito significa che la .app dell'installer è stata costruita senza"
...
MSG_WARN_CM048_PIPELINE_NOT_FOUND="Motore della memoria delle conversazioni non trovato. L'arricchimento delle conversazioni non può funzionare senza di esso."
...
MSG_WARN_COLIMA_START_RETRY="Colima non si è avviato correttamente (il socket Docker non era pronto). Nuovo tentativo tra %ss..."
...
MSG_WARN_CONTINUING_BECAUSE_ALLOW_PLAINTEXT_WAS_PASSED="Continuo perché è stato passato --allow-plaintext."
...
MSG_WARN_CONTINUING_WITHOUT_CONTACT_CARD_AUTO_FILL="Continuo senza la precompilazione dalla scheda contatto: Ostler te lo chiederà invece."
MSG_WARN_CONVERSATIONS_SENT_IMESSAGE_WILL_SILENTLY_FAIL="  Le conversazioni inviate a iMessage falliranno silenziosamente finché"
...
MSG_WARN_COULD_NOT_FIND_TAILSCALE_CLI_YOU="Impossibile trovare la CLI di Tailscale. Puoi configurarla manualmente più tardi."
...
MSG_WARN_DOCTOR_MISSING_FROM_APP_BUNDLE="  Di solito significa che la .app dell'installer è stata costruita senza"
...
MSG_WARN_COULD_NOT_PERSIST_REGION_JSON_CONTINUING="Impossibile salvare region.json (continuo - Doctor lo segnalerà)"
...
MSG_WARN_COULD_NOT_WRITE_PIPELINE_SIGNALS_JSON="Impossibile scrivere pipeline_signals.json. La diagnostica Doctor della Mail vuota userà valori predefiniti sicuri fino alla prossima installazione o ciclo."
...
MSG_WARN_DOCKER_DID_NOT_START_WITHIN_SECONDS="Docker non si è avviato entro %s secondi."
MSG_WARN_DOCKER_INSTALLED_BUT_NOT_RUNNING_WILL="Docker è installato ma non in esecuzione. Sarà necessario avviarlo."
MSG_WARN_DOCKER_OLLAMA_MID_INSTALL_HANG_READINESS="Docker / Ollama a meta installazione è bloccare le verifiche di prontezza."
...
MSG_WARN_IMESSAGE_BRIDGE_FAILED="Installazione del LaunchAgent del bridge iMessage non riuscita. Le risposte iMessage dell'utente-assistente non funzioneranno finché non riesegui l'installer o esegui INSTALL_SNIPPET.sh manualmente."
MSG_WARN_IMESSAGE_BRIDGE_SCRIPTS_NOT_BUNDLED_PLAINTEXT="Script del bridge iMessage non inclusi ed è stato passato --allow-plaintext; l'installazione del LaunchAgent verrà saltata. Le risposte iMessage dell'utente-assistente non funzioneranno."
MSG_WARN_ENCRYPTION_PASSPHRASE_VALIDATION_WILL_NOT_WORK="La cifratura non funzionerà."
MSG_WARN_ENCRYPTION_PASSPHRASE_VALIDATION_WILL_NOT_WORK_2="La cifratura non funzionerà, e"
...
MSG_WARN_FDA_EXTRACTOR_EXITED_NON_ZERO_LAST="L'estrattore FDA è uscito con codice diverso da zero (%s). Ultime 20 righe di output:"
...
MSG_WARN_FDA_MODULE_NOT_BUNDLED_LINE_3="Causa più probabile: una regressione di build ha rimosso la copia vendor. Scarica di nuovo la .app da ostler.ai/install."
MSG_WARN_FDA_MODULE_NOT_BUNDLED_PLAINTEXT="Modulo di estrazione FDA non incluso. Continuo perché è stato passato --allow-plaintext: l'estrazione istantanea dei dati verrà saltata."
MSG_WARN_FILEVAULT_NOT_ENABLED="FileVault NON è abilitato."
MSG_WARN_FIRST_MONTH_FREE_FAILED_NONFATAL="Impossibile attivare il primo mese gratuito in questo momento; l'installazione continuerà. Apri l'app iOS Companion una volta abbinata per risolvere."
MSG_WARN_FULL_DISK_ACCESS_NOT_GRANTED_TERMINAL="Full Disk Access non concesso a Terminal."
MSG_WARN_GB_RAM_DETECTED_WORKS_BUT_LIMITS="%s GB di RAM rilevati. Avrai l'assistente compatto (gemma4:e2b): affidabile, accurato, sotto il secondo sulle domande brevi, con chiamate a strumenti e un onesto 'non lo so' quando non sa. Per risposte più ricche su domande lunghe, 24 GB o più sbloccano l'assistente standard (qwen3.5:9b). Puoi cambiare Mac più tardi reinstallando."
MSG_WARN_GDPR_IMPORT_HAD_ERRORS_YOU_CAN="L'importazione GDPR ha avuto errori. Puoi rieseguirla con:"
MSG_WARN_GDPR_IMPORT_REQUIRED_FOR_PRODUCTISED_INSTALL="L'importazione GDPR fa parte dell'installazione di produzione. Senza di essa, il tuo grafo sociale (LinkedIn, Facebook, Instagram, WhatsApp, Twitter, Google Calendar) non può essere importato."
MSG_WARN_GDPR_IMPORT_WILL_BE_UNAVAILABLE_THIS_INSTANCE="L'importazione GDPR non sarà disponibile su questa istanza finché la pipeline di importazione non viene reinstallata."
...
MSG_WARN_HEALTH_CHECK_FAILED_PWG_CONVO_HELP="  Controllo di stato fallito: il motore della memoria delle conversazioni non è riuscito a caricarsi (pwg-convo o l'import della sua pipeline non è tornato correttamente)."
MSG_WARN_HOMEBREW_INSTALL_FAILED_EXIT="L'installer di Homebrew è uscito con %s. Seguono le ultime 30 righe di /tmp/ostler-brew-install.log:"
MSG_WARN_HOMEBREW_INSTALL_LOG_LAST_LINES="--- Log di installazione Homebrew (coda) ---"
MSG_WARN_DOCTOR_PIP_INSTALL_FAILED_EXIT="L'installazione pip di Doctor è uscita con %s. Seguono le ultime 30 righe di /tmp/ostler-doctor-pip.log:"
MSG_WARN_DOCTOR_PIP_LOG_LAST_LINES="--- Log di installazione pip di Doctor (coda) ---"
MSG_WARN_PIPELINE_PIP_INSTALL_FAILED_EXIT="L'installazione pip della pipeline è uscita con %s. Seguono le ultime 30 righe di /tmp/ostler-pipeline-pip.log:"
...
MSG_WARN_HUB_POWER_SCRIPTS_MISSING_FROM_APP_BUNDLE_3="  in Contents/Resources/hub-power/. La limitazione adattiva alla batteria non verrà installata; il resto dell'installazione continuerà."
...
MSG_WARN_IMAP_HOST_EMPTY_TRY_AGAIN="L'host IMAP è vuoto: riprova."
...
MSG_WARN_IMPORT_PIPELINE_NOT_BUNDLED_WITH_INSTALLER="Pipeline di importazione non inclusa nell'installer. Questo è il percorso di installazione di produzione; il pacchetto Python contact_syncer dovrebbe essere incluso nella .app."
MSG_WARN_INBOX_MEANS_ASSISTANT_WILL_READ_EVERY="INBOX significa che l'assistente leggerà ogni email che ricevi."
...
MSG_WARN_IS_CLOUD_PROVIDER_HOST="%s è un host di un provider cloud."
MSG_WARN_JWT_SECRET_BANLIST_REGENERATING_KEEP_CM019="JWT_SECRET in %s è nella banlist; rigenerazione per mantenere importabili i servizi del grafo di conoscenza"
MSG_WARN_JWT_SECRET_TOO_SHORT_CHARS_REGENERATING="JWT_SECRET in %s è troppo corto (%s < %s caratteri); rigenerazione"
...
MSG_WARN_LICENCE_SHIPS_UNDER_GOOGLE_S_GEMMA="Licenza: %s è distribuito sotto i Gemma Terms of Use di Google, non Apache 2.0."
...
MSG_WARN_MACOS_CONTACTS_PERMISSION_WAS_DECLINED_NOT="Il permesso Contatti di macOS è stato rifiutato o non ancora concesso."
MSG_WARN_MACOS_OUTDATED_WE_RECOMMEND_MACOS_13="macOS %s è obsoleto. Consigliamo macOS 13 (Ventura) o successivo."
MSG_WARN_MACOS_WILL_NOT_PROMPT_IT_FROM="macOS NON lo chiederà da uno script: devi concederlo manualmente."
...
MSG_WARN_RECOVERY_PASSPHRASE_REQUIRED="È necessaria una passphrase per cifrare i tuoi dati."
...
MSG_WARN_OSTLER_ASSISTANT_EXTRACTED_BUT_VERSION_CHECK="ostler-assistant estratto ma il controllo --version è fallito."
...
MSG_WARN_OSTLER_ASSISTANT_V_APPLE_SILICON_ONLY="ostler-assistant v%s è solo per Apple Silicon (rilevato: %s)."
...
MSG_WARN_PIP_INSTALL_FAILED_CM048_PIPELINE_WILL="  installazione pip fallita; il motore della memoria delle conversazioni non sarà disponibile."
MSG_WARN_PIP_INSTALL_FAILED_OSTLER_FDA_WILL="  installazione pip fallita; email-ingest ripiegherà sul python di sistema (potrebbe fallire anche a runtime)."
MSG_WARN_PIP_INSTALL_FAILED_OSTLER_KNOWLEDGE_WILL="  installazione pip fallita; ostler-knowledge non sarà disponibile."
MSG_WARN_PIP_INSTALL_FAILED_PWG_EMAIL_INGEST="  installazione pip fallita; motore di acquisizione email non disponibile. Il LaunchAgent orario emetterà comunque i file mbox ma non potrà acquisirli nel grafo finché non viene riparato."
MSG_WARN_CM021_SOURCE_NOT_FOUND="Sorgente del motore di acquisizione email non trovata nella .app; il job orario in background salverà i file di posta senza acquisirli."
MSG_WARN_OSTLER_FDA_SOURCE_NOT_FOUND_EMAIL_INGEST="sorgente ostler_fda non trovata nella .app; il LaunchAgent di email-ingest ripiegherà sul python di sistema a runtime."
...
MSG_WARN_PORT_1_ALREADY_USE_PID="La porta %s è già in uso da %s (PID %s)"
MSG_WARN_PORT_3000_ALREADY_USE_ANOTHER_SERVICE="  - Porta 3000 già in uso da un altro servizio"
...
MSG_WARN_PYTHON_TOO_OLD_NEED_3_10="Python %s è troppo vecchio (serve 3.10+). Installazione di Python 3.12..."
...
MSG_WARN_SAFARI_EXTENSION_COPY_FAILED_YOU_CAN="Copia dell'estensione Safari fallita; puoi installarla manualmente più tardi"
MSG_WARN_SECURITY_MODULE_NOT_FOUND_PASSKEY_SETUP="Modulo di sicurezza non trovato. La configurazione della passkey verrà saltata."
MSG_WARN_SECURITY_MODULE_LOOKED_FOR_PATH="  Cercato in: %s/ostler_security/pyproject.toml"
MSG_WARN_SECURITY_MODULE_MISSING_FROM_APP_BUNDLE="  Di solito significa che la .app dell'installer è stata costruita senza"
...
MSG_WARN_SOME_FEATURES_MAY_NOT_WORK_CORRECTLY="Alcune funzioni potrebbero non funzionare correttamente sulle versioni più vecchie."
...
MSG_WARN_TAILSCALE_DIDN_T_SIGN_WITHIN_3MIN="Tailscale non ha effettuato l'accesso entro 3 minuti. Puoi tornarci più tardi dalle Impostazioni."
MSG_WARN_TAILSCALE_ENV_PERSIST_VERIFY_FAILED="L'IP di Tailscale è stato scritto in .env ma una lettura successiva non l'ha trovato. L'iOS Companion potrebbe non rilevarlo: riesegui install.sh --repair se succede."
MSG_WARN_TAILSCALE_INSTALL_FAILED_YOU_CAN_INSTALL="Installazione di Tailscale fallita: puoi installarlo più tardi da tailscale.com"
...
MSG_WARN_USING_INBOX_ASSISTANT_WILL_READ_EVERY="Uso INBOX. L'assistente leggerà ogni email in arrivo."
MSG_WARN_VANE_CONTAINER_STARTED_BUT_HTTP_LOCALHOST="Il container di Vane si è avviato ma http://localhost:3000 non ha risposto entro 60s."
MSG_WARN_VANE_LOCAL_WEB_SEARCH_FAILED_START="Vane (ricerca web locale) non si è avviato. Cause comuni:"
MSG_WARN_WEB_SEARCH_OPTIONAL_REST_OSTLER_WORKS="  La ricerca web è opzionale; il resto di Ostler funziona senza di essa."
...
MSG_WARN_WIKI_COMPILED_BUT_WIKI_SITE_CONTAINER="Wiki compilato ma il container wiki-site non si è avviato."
MSG_WARN_WIKI_FIRST_COMPILE_FAILED_COMMON_CAUSES="Prima compilazione del wiki fallita. Cause comuni:"
MSG_WARN_WIKI_RECOMPILE_CATCHUP_LOAD_FAILED="Impossibile caricare il LaunchAgent di recupero del wiki del primo giorno. La ricostruzione giornaliera del wiki viene comunque eseguita; il tuo wiki si aggiornerà semplicemente il giorno dopo anziché entro l'ora."
...
MSG_WARN_WIKI_WILL_NOT_AUTO_UPDATE_MANUAL="Il wiki non si aggiornerà automaticamente; la ricostruzione manuale resta disponibile:"
...
MSG_WARN_YOU_CAN_RUN_SECURITY_SETUP_LATER="Puoi eseguire la configurazione della sicurezza più tardi: python3 -m ostler_security.setup_wizard"
...
MSG_ERR_OSTLER_ASSISTANT_BINARY_NOT_MACH_O="Il binario ostler-assistant in %s non è un eseguibile Mach-O."
...
MSG_FAIL_ARCH_INTEL_NOT_SUPPORTED_V1_0="I Mac Intel non sono supportati nella v1.0. È richiesto Apple Silicon (M1, M2, M3 o M4). Il supporto Intel arriverà nella v1.0.1."
MSG_FAIL_AT_LEAST_16_GB_RAM_REQUIRED="Sono richiesti almeno 16 GB di RAM. Tu ne hai %s GB. Consigliati 24 GB."
MSG_FAIL_CM042_SIGNATURE_FAILED="Installazione di Ostler RemoteCapture interrotta: controllo della firma o della notarizzazione fallito. Il bundle è stato lasciato in /Applications per l'assistenza. Scrivi a support@ostler.ai e riesegui l'installer."
...
MSG_FAIL_IMPORT_PIPELINE_INSTALL_FAILED_RE_RUN_INSTALLER="Installazione della pipeline di importazione fallita. Il bundle contact_syncer è richiesto per l'installazione di produzione. Riesegui con --allow-plaintext per dev/CI, oppure scarica di nuovo l'installer e riprova."
...
MSG_FAIL_CM048_PIPELINE_REQUIRED_RE_RUN="Il motore della memoria delle conversazioni è richiesto. Riesegui con --allow-plaintext per dev/CI, oppure correggi il bundle mancante sopra e riprova."
...
MSG_FAIL_PYSQLCIPHER3_REQUIRED_ENCRYPTED_DATABASES_RE_RUN="sqlcipher3 è richiesto per i database cifrati. Riesegui con --allow-plaintext per dev/CI, oppure correggi l'errore pip sopra e riprova."
MSG_FAIL_THIS_INSTALLER_MACOS_ONLY_LINUX_SUPPORT="Questo installer è solo per macOS. Il supporto Linux arriverà presto."
MSG_FAIL_XCODE_COMMAND_LINE_TOOLS_INSTALL_DID="L'installazione degli Xcode Command Line Tools non si è completata in 15 minuti. Apri il Terminale ed esegui 'xcode-select --install', fai clic su Installa nella finestra di dialogo di macOS, attendi che finisca, poi riesegui questo installer."
...
MSG_FAIL_HOMEBREW_NOT_ON_PATH="Homebrew è installato in /opt/homebrew/bin/brew ma il comando 'brew' non è nel PATH dopo l'eval di shellenv. Apri un nuovo Terminal e riesegui l'installer."
MSG_FAIL_COLIMA_MISSING_AFTER_BREW="'brew install colima docker docker-compose' ha segnalato successo ma colima non è nel PATH. Controlla %s per gli errori di Homebrew. Ripristino: apri Terminal ed esegui 'brew install colima docker docker-compose' manualmente, poi riesegui l'installer."
MSG_FAIL_DOCKER_CLI_MISSING_AFTER_BREW="'brew install colima docker docker-compose' ha segnalato successo ma la CLI docker non è nel PATH. Controlla %s. Ripristino: 'brew install docker' manualmente poi riesegui l'installer."
...
MSG_FAIL_EMBED_HEALTHCHECK="Ollama è in esecuzione ma il modello di embedding non ha restituito alcun vettore (HTTP diverso da 200, o un risultato vuoto). La scheda Persone, la ricerca e la navigazione sarebbero tutte vuote. Controlla %s. Ripristino: assicurati che l'app Ollama (non la formula Homebrew) sia installata è attiva, poi riesegui l'installer."
MSG_FAIL_SQLCIPHER_MISSING_AFTER_BREW="'brew install sqlcipher' ha segnalato successo ma sqlcipher non è nel PATH. Controlla %s. Ripristino: 'brew install sqlcipher' manualmente poi riesegui l'installer."
...
MSG_PROMPT_REUSE_SETTINGS_HELP="Abbiamo rilevato un precedente tentativo di installazione su questo Mac. Le domande a cui hai già risposto (nome, nome dell'assistente, fuso orario, prefisso paese, canali e così via) verranno riutilizzate così non dovrai reinserirle. Scegli Sì per continuare da dove eri rimasto, o No per ripercorrere le domande dall'inizio."
...
MSG_PROMPT_PERMS_OK_HELP="macOS chiederà l'accesso a Contatti e a File e cartelle. Il Full Disk Access opzionale può essere concesso più tardi."
...
MSG_PROMPT_USER_ID_HELP="Un nome breve che il tuo assistente userà per rivolgersi a te (es. 'Andy', 'Andrew', 'Sig.ra Smith'). È quello che appare nei tuoi brief mattutini e nelle risposte in chat. Diverso dal tuo nome completo qui sopra."
...
MSG_PROMPT_COUNTRY_CODE_DETECTED_FROM_PHONE_HELP="Rilevato dal tuo numero di telefono qui sopra. Scegli Sì per usarlo, o No per inserire un prefisso paese diverso."
...
MSG_PROMPT_ASSISTANT_NAME_HELP_FULL="Il nome nel campo è un suggerimento casuale: sovrascrivilo con quello che preferisci. Marvin, Samantha, Joshua, Friday, Athena, Sage e Rosie sono tutte scelte popolari." # assistant-name-exempt: F6.1 suggestion-pool exemplar
MSG_PROMPT_ASSISTANT_NAME_HELP_SHORT="Digita qualsiasi nome ti piaccia: il suggerimento è solo un punto di partenza."

MSG_PROMPT_CHANNEL_CHOICE_TITLE="Come ti raggiungera il tuo assistente?"
MSG_PROMPT_CHANNEL_CHOICE_HELP="Scegli i canali di messaggistica che vorresti far usare al tuo assistente. Puoi cambiarli più tardi nella sezione Doctor dell'app."

MSG_PROMPT_WHATSAPP_CONSENT_TITLE="Abilitare la messaggistica WhatsApp per il tuo assistente?"
MSG_PROMPT_WHATSAPP_CONSENT_HELP="WhatsApp Web è un servizio di terze parti. Abilitandolo, accetti che i tuoi messaggi passino attraverso l'infrastruttura di WhatsApp prima di raggiungere la tua istanza locale di Ostler, e che WhatsApp (Meta Platforms Ireland Ltd) possa sospendere, limitare o chiudere il tuo account WhatsApp a causa dell'uso automatizzato. Puoi disabilitarlo più tardi dalle Impostazioni."
...
MSG_PROMPT_IMESSAGE_FDA_ASSIST_LINE1="Impostazioni di Sistema è aperto su Full Disk Access."
...
MSG_PROMPT_INSTALLER_FDA_ASSIST_LINE1="Impostazioni di Sistema è aperto su Full Disk Access."
MSG_PROMPT_INSTALLER_FDA_ASSIST_LINE2="Trova \"OstlerInstaller\" nell'elenco e attivalo."
MSG_PROMPT_INSTALLER_FDA_ASSIST_LINE3="Clicca Fine quando hai finito e Ostler leggerà la tua cronologia di Safari, le Note, gli iMessage e Mail."
...
MSG_PROMPT_INSTALLER_FDA_PREWARN_LINE1="Ora macOS ti chiederà di concedere il Full Disk Access a OstlerInstaller."
MSG_PROMPT_INSTALLER_FDA_PREWARN_LINE2="Dopo aver attivato l'interruttore, macOS mostrerà una finestra che ti chiede di scegliere 'Esci e riapri' o 'Più tardi'."
MSG_PROMPT_INSTALLER_FDA_PREWARN_LINE3="Clicca Esci e riapri. L'installer si riavvierà da solo e continuerà automaticamente da questo passaggio."
...
MSG_INFO_INSTALLER_FDA_ASSIST_OPENING="Apertura di Impostazioni di Sistema così puoi concedere il Full Disk Access all'installer..."
...
MSG_INFO_INSTALLER_FDA_ASSIST_STILL_NEEDED="Full Disk Access ancora non concesso. Continuo senza; puoi rieseguire l'installer più tardi per estrarre Safari / Note / iMessage."

MSG_PROMPT_IMESSAGE_ALLOWED_TITLE="Contatti consentiti"
MSG_PROMPT_IMESSAGE_ALLOWED_HELP="Persone fidate: numeri di telefono ed email Apple ID (separati da virgola). %s risponde solo alle persone in questo elenco; i messaggi di chiunque altro vengono ignorati. È richiesta almeno una voce.
...
MSG_PROMPT_MAIL_NOT_CONNECTED_HELP="Apple Mail non ha ancora account connessi su questo Mac, quindi Ostler non avrà posta da leggere. Scegli Sì per aprire ora Impostazioni di Sistema > Account Internet (puoi aggiungere iCloud, Gmail o Outlook). Scegli No per saltare; puoi aggiungere un account più tardi e Doctor mostrerà un promemoria se non arriva posta entro 24 ore."

MSG_PROMPT_MAIL_EXTEND_HISTORY_TITLE="Recuperare l'intera cronologia di Apple Mail?"
MSG_PROMPT_MAIL_EXTEND_HISTORY_HELP="Per impostazione predefinita Ostler legge gli ultimi cinque anni di Apple Mail. Se su questo Mac ne conservi di più e vuoi tutto nel tuo grafo di conoscenza, scegli Sì per recuperare ora l'intera cronologia locale (per una casella grande può richiedere un po' più di tempo). Scegli No per mantenere la finestra di cinque anni; puoi sempre estenderla più tardi da Doctor."
...
MSG_PROMPT_EMAIL_INBOX_CONFIRM_HELP="INBOX significa che l'assistente leggerà ogni email che ricevi. Consigliamo vivamente invece un'etichetta/cartella dedicata."
...
La maggior parte degli archivi impiega da 1 a 3 giorni per arrivare via email. Quando gli ZIP arrivano, mettili nella tua cartella Download e Ostler li troverà automaticamente.

Salta quelli che non usi; puoi sempre importarne altri più tardi."

MSG_PROMPT_FILEVAULT_SKIP_TITLE="Continuare senza FileVault?"
MSG_PROMPT_FILEVAULT_SKIP_HELP="FileVault è fortemente consigliato. Senza di esso, l'accesso fisico al tuo Mac significa accesso ai tuoi dati."
...
MSG_PROMPT_MANUAL_EXPORTS_PATH_HELP="Ostler può importare archivi di social media e piattaforme - la tua intera storia con amici, familiari, luoghi, opinioni - fin dall'inizio. Più cose Ostler sa il primo giorno, più è utile il primo giorno. Puoi anche aggiungerli più tardi; nessuna fretta.
...
Ostler cercherà in ~/Downloads per impostazione predefinita. Vuoi una cartella diversa? Scegline una qui sotto. Altrimenti, salta e importa più tardi."
...
MSG_PROMPT_FDA_PRESET_CHOICE_RECOMMENDED="Consigliata. Include Apple Mail, Contatti, Calendario, Note, Messages, Promemoria, cronologia di Safari e segnalibri di Safari. La cronologia di WhatsApp Desktop e la cronologia di Chrome vengono aggiunte automaticamente quando l'app è installata. Esclude i dati di riconoscimento facciale di Foto e qualsiasi archivio di export di terze parti."
MSG_PROMPT_FDA_PRESET_CHOICE_EVERYTHING="Tutto. Consigliata + eventi di Foto (nessun riconoscimento facciale). Il riconoscimento facciale di Foto resta disattivato finché non lo spunti deliberatamente."
MSG_PROMPT_FDA_PRESET_CHOICE_CUSTOMISE="Personalizza. Scegli ogni sorgente nella schermata successiva. Le sorgenti sensibili restano disattivate finché non le spunti."
...
Continuando comprendi e accetti di essere l'unico responsabile del trattamento e della conservazione di questi dati sulla tua macchina, proprio come i messaggi email già presenti sul tuo disco rigido.

Nota legale: Per i record che importi su questo Mac, sei il titolare e il responsabile del trattamento ai sensi del diritto del Regno Unito e dell'UE (UK GDPR Articolo 4(7) e 4(8)). Creative Machines non riceve mai questi dati e non è il titolare. Il tuo trattamento per scopi personali e domestici rientra nell'Articolo 2(2)(c) del GDPR UK/UE.

Leggi di più su docs.ostler.ai/privacy/third-party-data."
...
MSG_PROMPT_TAILSCALE_CONFIRM_HELP="Tailscale dà a questo Mac un indirizzo privato stabile che il tuo iPhone e il tuo Watch possono raggiungere da ovunque: cifrato, senza esposizione pubblica."
...
MSG_HYDRATE_CALENDAR_STARTED="Caricamento dei tuoi ultimi 90 giorni di calendario (la cronologia più lunga viene recuperata in background)"
MSG_HYDRATE_CALENDAR_DONE="Importati %s eventi"
MSG_HYDRATE_WIKI_RECOMPILE="Costruzione del tuo wiki. Ostler sta scrivendo un breve riepilogo per ciascuna delle tue persone, organizzazioni e argomenti chiave, quindi su una rubrica grande questo può richiedere da pochi minuti fino a circa un'ora. Succede una sola volta, viene eseguito interamente sul tuo Mac, ed è sicuro lasciarlo in corso."
...
MSG_INITIAL_HYDRATE_QDRANT_EMPTY_DEFERRED="L'indice di ricerca si popolerà in background al termine dell'installazione"
MSG_HYDRATE_DONE="Il tuo grafo è pronto: %s persone, %s eventi"
...
MSG_HYDRATE_SKIPPED_NO_CONTACTS="Nessun contatto iCloud da importare. Puoi aggiungerlo più tardi dalle Impostazioni."
MSG_HYDRATE_SKIPPED_NO_EVENTS="Nessun evento di calendario negli ultimi 5 anni. Puoi recuperarlo più tardi dalle Impostazioni."
...
MSG_HYDRATE_EMAIL_STARTED="Lettura dei tuoi ultimi 90 giorni di email: le tue email restano su questo Mac (la cronologia più lunga viene recuperata in background)"
MSG_HYDRATE_EMAIL_DONE="Trovate %s persone nelle tue email recenti"
MSG_HYDRATE_EMAIL_SKIPPED_NO_MAIL_CONTENT="Nessuna email recente da leggere. Puoi aggiungere un account Mail in Apple Mail e rieseguire più tardi."
MSG_HYDRATE_EMAIL_SKIPPED_FDA_PENDING="Lettore di email non ancora pronto. Puoi aggiungere un account Mail in Apple Mail e rieseguire più tardi."
MSG_HYDRATE_EMAIL_BACKGROUND_CONTINUES="Le email si stanno ancora caricando in background: il tuo wiki si riempirà nel corso della prossima ora."
...
MSG_PROMPT_OPEN_MAIL_TO_POPULATE_TITLE="Aprire Apple Mail così può iniziare a sincronizzare?"
...
MSG_PROMPT_OPEN_CALENDAR_TO_POPULATE_TITLE="Aprire Calendario così può iniziare a sincronizzare?"
...
MSG_PROMPT_OPEN_CONTACTS_TO_POPULATE_TITLE="Aprire Contatti così può iniziare a sincronizzare?"
...
MSG_INFO_WAITING_FOR_APP_HEARTBEAT="Attesa della sincronizzazione di %s ancora in corso (%ss trascorsi, %ss rimanenti). La prima sincronizzazione di iCloud può richiedere alcuni minuti su un accesso nuovo."
MSG_OK_APP_HAS_POPULATED="%s ha popolato il suo archivio locale. Proseguo."
MSG_INFO_APP_POPULATE_TIMEOUT_CONTINUING="Non abbiamo rilevato la sincronizzazione di %s entro la finestra di attesa. Proseguo; puoi rieseguire l'idratazione dalle Impostazioni più tardi."

# Three-state-aware copy for the three sources. These replace the
# old binary "no data" copy that conflated states 1 and 2.
MSG_INFO_MAIL_CONFIGURED_BUT_NOT_FETCHED="Account Apple Mail visibili: %s. Apri Mail.app una volta così può iniziare a scaricare i messaggi."
MSG_INFO_CALENDAR_CONFIGURED_BUT_NOT_FETCHED="Account di calendario visibili: %s. Apri Calendario.app una volta così può sincronizzare i tuoi eventi."
MSG_INFO_CONTACTS_CONFIGURED_BUT_NOT_FETCHED="Account di contatti visibili: %s. Apri Contatti.app una volta così può sincronizzare la tua rubrica."
...
MSG_HYDRATE_CONTACTS_READ_FAILED="I tuoi contatti sono su questo Mac ma Ostler ne ha importati 0, il che è inatteso. L'importazione riprovera automaticamente in background. Se persiste, riesegui l'idratazione dalle Impostazioni o controlla il log di installazione."
MSG_HYDRATE_CONTACTS_RESYNC_SCHEDULED="Ostler continuerà a controllare in background e importera i tuoi contatti automaticamente una volta che iCloud avrà finito di sincronizzare."
...
MSG_HYDRATE_WHATSAPP_SKIPPED_NO_CHATS="Nessuna chat WhatsApp da leggere. Puoi rieseguire più tardi dalle Impostazioni."
MSG_HYDRATE_WHATSAPP_SKIPPED_NO_APP="WhatsApp Desktop non è installato. Installalo dal Mac App Store e riesegui dalle Impostazioni."
MSG_HYDRATE_WHATSAPP_SKIPPED_FDA_PENDING="Lettore di WhatsApp non ancora pronto. Puoi rieseguire più tardi dalle Impostazioni."
MSG_HYDRATE_WHATSAPP_BACKGROUND_CONTINUES="WhatsApp si sta ancora caricando in background: il tuo wiki si riempirà nel corso della prossima ora."
...
MSG_HYDRATE_BROWSING_SKIPPED_NO_DATA="Nessuna cronologia di navigazione da importare. Puoi rieseguire più tardi dalle Impostazioni."
MSG_HYDRATE_BROWSING_SKIPPED_FDA_PENDING="Lettore della cronologia di navigazione non ancora pronto. Puoi rieseguire più tardi dalle Impostazioni."
MSG_HYDRATE_BROWSING_BACKGROUND_CONTINUES="La cronologia di navigazione si sta ancora caricando in background: il tuo wiki si riempirà nel corso della prossima ora."
...
MSG_CM019_SETUP_FAILED="La configurazione dell'arricchimento delle preferenze non si è completata. Le tue pagine delle preferenze si riempiranno una volta risolto; il resto di Ostler non è interessato."
MSG_CM019_SETUP_EXISTS="Arricchimento delle preferenze già configurato"
...
MSG_HYDRATE_IMESSAGE_SKIPPED_NO_DATA="Nessuna cronologia iMessage da leggere. Puoi rieseguire più tardi dalle Impostazioni."
MSG_HYDRATE_IMESSAGE_SKIPPED_FDA_PENDING="Lettore di iMessage non ancora pronto. Puoi rieseguire più tardi dalle Impostazioni."
MSG_HYDRATE_IMESSAGE_BACKGROUND_CONTINUES="iMessage si sta ancora caricando in background: il tuo wiki si riempirà nel corso della prossima ora."
...
MSG_HYDRATE_PEOPLE_SKIPPED_NO_DATA="Nessuna persona da indicizzare per ora. Puoi rieseguire più tardi dalle Impostazioni."
MSG_HYDRATE_PEOPLE_SKIPPED_FDA_PENDING="Indicizzatore delle persone non ancora pronto. Puoi rieseguire più tardi dalle Impostazioni."
MSG_HYDRATE_PEOPLE_BACKGROUND_CONTINUES="Sto ancora indicizzando le tue persone in background; la ricerca si riempirà a breve."
...
MSG_INFO_CLT_KEEP_ANSWERING_BACKGROUND="La finestra di installazione dei Command Line Tools è apparsa davanti a questa finestra: clicca Installa su di essa, poi torna qui (o attendi qualche secondo, riporteremo questa finestra in primo piano per te). Gli strumenti si scaricano in background mentre continui a rispondere alle domande qui sotto; nulla qui è bloccato."
...
MSG_PROMPT_IMESSAGE_AUTOMATION_INCOMING_HELP="Ostler chiederà ora a macOS il permesso di comunicare con Messages.app. macOS mostrerà un popup che dice \"OstlerInstaller vuole accedere per controllare Messages\": clicca Consenti così l'assistente può inviare e ricevere iMessage per tuo conto. Senza questo permesso i messaggi iMessage non lasceranno mai silenziosamente la macchina. È una concessione una tantum; puoi modificarla più tardi in Impostazioni di Sistema > Privacy e Sicurezza > Automazione."
...
MSG_INFO_RECOVERY_KEY_REVEALED_BODY="Annotala o stampala ora. È l'unico modo per rientrare se perdi la tua passphrase E il tuo Portachiavi diventa inaccessibile. Ostler non può recuperarla per te: la chiave non lascia mai questo Mac e non è memorizzata su alcun server."
...
MSG_INFO_PAIR_IPHONE_HELP="Apri l'app Ostler sul tuo iPhone e scansiona questo codice QR per collegarlo a questo Hub. Puoi anche abbinarlo più tardi dal menu Impostazioni dell'Hub."
...
MSG_WARN_WIKI_RECOMPILE_SCRIPTS_NOT_BUNDLED="Script di ricompilazione del wiki non inclusi nell'installer. Il wiki non si aggiornerà automaticamente."

# F3 - legal package missing
MSG_WARN_LEGAL_PACKAGE_NOT_BUNDLED_CONSENT_DEGRADED="pacchetto legal non incluso nell'installer. I gate di consenso Articolo 9 / WhatsApp / voce solleveranno ModuleNotFoundError finché non viene reinstallato."

# F4 - gws (Google Workspace CLI) install
MSG_OK_GWS_INSTALLED_AT_VERSION_DEST="Google Workspace CLI v%s installato in %s"
MSG_OK_GWS_ALREADY_INSTALLED_AT_VERSION="Google Workspace CLI v%s già installato, lasciato al suo posto"
...
MSG_WARN_GWS_INSTALLED_BUT_VERSION_PROBE_FAILED="Google Workspace CLI installato in %s ma la verifica --version è fallita."

# F5 - ical-query.sh wrapper
MSG_OK_ICAL_QUERY_WRAPPER_INSTALLED_AT="Bridge calendario iCloud / CalDAV installato in %s"
MSG_WARN_ICAL_QUERY_WRAPPER_NOT_EXECUTABLE_AT="Il bridge calendario iCloud / CalDAV in %s non è eseguibile. Il calendario non restituira eventi."
...
MSG_FAIL_GRAPH_DB_DOCKER_NOT_READY="Docker non era pronto in tempo per avviare i database del grafo della conoscenza. Assicurati che Colima o Docker sia in esecuzione, poi riesegui l'installer."

MSG_FAIL_GRAPH_DB_PULL_FAILED="Impossibile scaricare le immagini dei database del grafo della conoscenza dopo diversi tentativi. Di solito è un problema di rete. Controlla la connessione a Internet e riesegui l'installer."

MSG_FAIL_GRAPH_DB_UP_FAILED="I database del grafo della conoscenza sono stati scaricati ma non è stato possibile avviarli. Riesegui l'installer; se il problema persiste, apri il Terminale ed esegui: cd ~/.ostler && docker compose up -d qdrant oxigraph redis"

MSG_HYDRATE_CONTACTS_EMAIL_COVERAGE_LOW="Importati %s contatti con numeri di telefono ma quasi senza indirizzi e-mail (%s telefono contro %s e-mail). Di solito significa che il lettore dei contatti ha scartato le e-mail. I tuoi contatti restano utilizzabili; vedi /tmp/ostler-hydrate-contacts.log e riesegui l'importazione dei dati dalle Impostazioni una volta risolto."

MSG_HYDRATE_EMAIL_HEARTBEAT="  Lettura delle tue e-mail ancora in corso (%ss finora). Su un Mac con anni di cronologia può richiedere un po' di tempo."

MSG_HYDRATE_EMAIL_PREFERENCES_BACKGROUND_CONTINUES="Le preferenze e-mail si stanno ancora caricando in background. Il tuo wiki si riempirà a breve."

MSG_HYDRATE_EMAIL_PREFERENCES_DONE="Caricate %s preferenze dalla cronologia delle tue e-mail"

MSG_HYDRATE_EMAIL_PREFERENCES_HEARTBEAT="  Caricamento delle preferenze e-mail ancora in corso (%ss finora). Una cronologia estesa può richiedere qualche minuto."

MSG_HYDRATE_EMAIL_PREFERENCES_SKIPPED_NO_FILE="Nessun file di preferenze e-mail configurato. Niente da caricare."

MSG_HYDRATE_EMAIL_PREFERENCES_SKIPPED_NO_FILE_AT="Nessun file di preferenze e-mail trovato in %s. Niente da caricare."

MSG_HYDRATE_EMAIL_PREFERENCES_SKIPPED_PIPELINE_PENDING="La pipeline delle preferenze non è ancora pronta. Puoi rieseguirla più tardi dalle Impostazioni."

MSG_HYDRATE_EMAIL_PREFERENCES_STARTED="Caricamento delle tue preferenze e-mail. Tutto resta su questo Mac e può richiedere qualche minuto."

MSG_HYDRATE_IMESSAGE_HEARTBEAT="  Lettura della cronologia iMessage ancora in corso (%ss finora). Una cronologia messaggi estesa può richiedere diversi minuti."

MSG_HYDRATE_PLACES_DONE="La tua sezione Places è stata creata"

MSG_HYDRATE_PLACES_ERROR_WARN="La costruzione di Places non è stata completata (errore imprevisto). La tua pagina Places potrebbe essere incompleta. Vedi /tmp/ostler-places-ingest.log"

MSG_HYDRATE_PLACES_GUARD_WARN="La costruzione di Places ha incontrato un problema: esistono segnali di posizione ma non è stato prodotto alcun luogo. La tua pagina Places potrebbe restare vuota. Vedi /tmp/ostler-places-ingest.log"

MSG_HYDRATE_PLACES_SKIPPED="Nessun segnale di posizione trovato per ora; Places si riempirà man mano che il tuo calendario si popola"

MSG_HYDRATE_PLACES_STARTED="Creazione dei tuoi luoghi (Places) a partire dai posti in cui ti incontri"

MSG_INFO_ASSISTANT_FINAL_RESTART_FDA="Riavvio dell'assistente perché rilevi l'Accesso completo al disco appena concesso (necessario per leggere la cronologia di Messaggi)."

MSG_INFO_DAEMON_FDA_LATER_PREANNOUNCE="Un'altra autorizzazione (cronologia di Messaggi per il tuo assistente) arriva verso la fine, una volta installato il tuo assistente – te la indicheremo allora."

MSG_INFO_DEDUPE_COMPLETE_NO_CATCHUP="Contatti duplicati uniti completamente durante l'installazione; nessun recupero in background necessario"

MSG_INFO_DEDUPE_DEFERRED_BACKGROUND="La maggior parte dei contatti duplicati è stata unita. Il resto terminerà in background dopo l'installazione – il tuo wiki si aggiornerà automaticamente."

MSG_INFO_DEDUPE_MERGED="Contatti duplicati uniti"

MSG_INFO_DEDUPE_STILL_MERGING="Unione dei contatti duplicati ancora in corso – le rubriche grandi possono richiedere diversi minuti (%ss trascorsi)"

MSG_INFO_FOLDER_ACCESS_DENIED_GUIDANCE="Concedi l'accesso in Impostazioni di Sistema > Privacy e sicurezza > File e cartelle (o Accesso completo al disco) e riesegui, oppure indica manualmente a Ostler la cartella delle esportazioni qui sotto."

MSG_INFO_GDPR_SCAN_BLOCKED_BY_PERMISSIONS="Impossibile esaminare una o più cartelle alla ricerca di esportazioni di dati perché macOS ha bloccato l'accesso. Concedi l'accesso e riesegui, oppure indicami manualmente la cartella delle esportazioni."

MSG_INFO_INSTALLER_FDA_WALKAWAY_PREANNOUNCE="L'Accesso completo al disco per l'installer è a posto. Da qui in poi la lunga installazione procede da sola – puoi allontanarti."

MSG_INFO_INSTALLING_COREUTILS_GTIMEOUT="Installazione di GNU coreutils (per limiti di tempo sui passaggi lunghi)..."

MSG_INFO_INSTALLING_OSTLER_SECURITY_INTO_CM048_VENV="  Installazione della dipendenza di archiviazione cifrata nel venv della memoria delle conversazioni..."

MSG_INFO_PULLING_GRAPH_DB_IMAGES="Download dei database del grafo della conoscenza (solo alla prima esecuzione). Su un'installazione nuova può richiedere un minuto..."

MSG_INFO_SAFARI_EXTENSION_ENABLE_GUIDANCE="Resta un passaggio manuale: apri Safari, scegli Safari > Impostazioni > Estensioni e spunta Ostler per attivarlo."

MSG_INFO_TAILSCALE_SIGNIN_LATER_PREANNOUNCE="Ricevuto – puoi allontanarti mentre Ostler si installa. Verso la fine c'è un breve passaggio facoltativo: l'accesso a Tailscale perché il tuo iPhone e il tuo Watch possano raggiungere questo Mac da ovunque. A quel punto apriremo il tuo browser."

MSG_MODELFIT_HEADER="Scelta del modello dell'assistente adatto al tuo Mac (%s, %s GB di RAM, contesto dell'assistente %s token):"

MSG_MODELFIT_PILL_FITS="Adatto"

MSG_MODELFIT_PILL_NOFIT="Non adatto"

MSG_MODELFIT_PILL_SLOW="Può essere lento"

MSG_MODELFIT_RECOMMENDED_TAG="  <- Consigliato"

MSG_MODELFIT_ROW="  %s  %s (%s, %s)"

MSG_MODELFIT_SELECTED="Modello IA: %s (%s) – il più adatto ai tuoi %s GB di RAM con la finestra di contesto richiesta dall'assistente"

MSG_OK_COREUTILS_GTIMEOUT_INSTALLED="GNU coreutils installato (i passaggi lunghi ora hanno un limite di tempo)"

MSG_OK_DEDUPE_CATCHUP_LOADED="LaunchAgent di deduplicazione contatti in background caricato (termina l'unione dei duplicati dopo l'installazione, poi si ferma)"

MSG_PROMPT_INSTALLER_FDA_RECOVER_BUTTON="Continua"

MSG_PROMPT_INSTALLER_FDA_RECOVER_LINE1="Ostler sta per leggere i dati del tuo Mac, ma l'Accesso completo al disco per OstlerInstaller è ancora disattivato. Trova \"OstlerInstaller\" in Impostazioni di Sistema (ora aperto su Accesso completo al disco) e attivalo."

MSG_PROMPT_INSTALLER_FDA_RECOVER_LINE2="Oppure fai clic su Continua per completare l'installazione con meno dati – potrai concedere l'accesso e rieseguire l'estrattore più tardi."

MSG_PROMPT_INSTALLER_FDA_RECOVER_TITLE="Accesso completo al disco ancora necessario"
...
MSG_WARN_COREUTILS_GTIMEOUT_NOT_AVAILABLE="Impossibile installare GNU coreutils; i passaggi lunghi verranno eseguiti senza limite di tempo (una riga di avanzamento mostra comunque che stanno lavorando)."

MSG_WARN_DEDUPE_CATCHUP_LOAD_FAILED="Impossibile caricare il LaunchAgent di deduplicazione contatti in background. I duplicati verranno comunque uniti dal passaggio di manutenzione giornaliero; ci vorrà solo più tempo."

MSG_WARN_DEDUPE_INCOMPLETE="Il passaggio di deduplicazione sull'intero grafo non si è concluso in modo pulito (vedi %s); si continua"

MSG_WARN_FOLDER_ACCESS_DENIED_SCAN="Impossibile leggere %s per cercare esportazioni di dati. macOS sta bloccando l'accesso a quella cartella."

MSG_WARN_GRAPH_DB_PULL_RETRY="Il download del database non è terminato (tentativo %s di %s). Nuovo tentativo tra %ss..."

MSG_WARN_GRAPH_DB_UP_RETRY="I database del grafo della conoscenza non si sono avviati (tentativo %s di %s). Nuovo tentativo..."

MSG_WARN_OSTLER_SECURITY_INSTALL_FAILED_CM048="  Impossibile installare la dipendenza di archiviazione cifrata nel venv della memoria delle conversazioni; l'arricchimento delle conversazioni non verrà eseguito."

MSG_WARN_OSTLER_SECURITY_SOURCE_MISSING_CM048="  Sorgente della dipendenza di archiviazione cifrata non trovata in SCRIPT_DIR; il motore della memoria delle conversazioni non può caricarsi e l'arricchimento delle conversazioni non verrà eseguito."

MSG_WARN_PREFS_HEADLINE_HINT="Di solito significa che non era presente alcuna esportazione di musica/cibo (Spotify, Apple Music, Uber Eats, Google Takeout), o che i dati non sono stati categorizzati. Aggiungi quelle esportazioni, riesegui dalle Impostazioni e poi ricostruisci il wiki."

MSG_WARN_PREFS_NO_HEADLINE_CATEGORIES="Importate %s preferenze, ma nessuna è finita sotto Food, Music o Professional. Le tue pagine wiki Food e Music saranno vuote."

MSG_WARN_PREFS_UNCATEGORISED="%s preferenze su %s (%s%%) non hanno categoria e non compariranno in nessuna pagina di argomento. Controlla il formato dell'esportazione di origine."
