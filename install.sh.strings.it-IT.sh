...
MSG_INFO_THIS_MAY_TAKE_5_15_MINUTES="Può richiedere 5-15 minuti a seconda di quanti dati hai..."
...
MSG_WARN_HEALTH_CHECK_FAILED_PWG_CONVO_HELP="  Controllo di stato fallito: pwg-convo --help non è tornato correttamente."
...
MSG_FAIL_XCODE_COMMAND_LINE_TOOLS_INSTALL_DID="L'installazione degli Xcode Command Line Tools non si è completata in 10 minuti. Esegui 'xcode-select --install' manualmente, accetta la finestra, poi riesegui questo installer."
...
MSG_STEP_INSTALLING_THIS_TAKES_A_WHILE="Installazione (può richiedere un po': sentiti libero di andare via)"
