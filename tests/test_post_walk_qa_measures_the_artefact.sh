...
ssh() {
    ...
    for a in "$@"; do cmd="$a"; done     # last arg is the remote command;
                                          ...
                                          # ships bash 3.2.
    case "$cmd" in
        *shasum*) printf '%s  %s\n' "$STUB_SHA" "/Users/x/Downloads/OstlerInstaller-1.0.50.dmg"; return 0 ;;
...
expect_source "one matching DMG on the box" 0 \
    "/Users/x/Downloads/OstlerInstaller-1.0.50.dmg" "measured(shasum"
...
expect_source "two matching DMGs"           0   "/Users/x/Downloads/OstlerInstaller-1.0.50.dmg
/Users/x/Desktop/OstlerInstaller-1.0.50.dmg" "2 copies"
...
expect_source "CONTROL: a v1.0.49 DMG does not satisfy a v1.0.50 walk" 0 \
    "/Users/x/Downloads/OstlerInstaller-1.0.49.dmg" "no OstlerInstaller-1.0.50.dmg"
