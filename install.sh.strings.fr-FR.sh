...
MSG_STEP_SETUP_ANSWER_FEW_QUESTIONS_THEN_WALK="Configuration (répondez à quelques questions, puis laissez faire)"
...
MSG_INFO_CLT_STILL_INSTALLING_ELAPSED="  Toujours en attente des Command Line Tools (écoulé : %ss)..."
...
MSG_INFO_THIS_MAY_TAKE_5_15_MINUTES="Cela peut prendre de 5 à 15 minutes selon la quantité de données que vous possédez..."
...
MSG_OK_POWER_SOURCE_AC_GOOD_10_15="Source d'alimentation : secteur (idéal pour l'installation de 10 à 15 minutes)"
...
MSG_WARN_BLOCK_3_1_CM024_PRODUCTISATION_STACK="Le bloc 3.1 de la pile de productisation du service Knowledge ajoute pyproject.toml…"
...
MSG_WARN_HEALTH_CHECK_FAILED_PWG_CONVO_HELP="  Échec du contrôle de l'état : pwg-convo --help n'a pas retourné proprement."
...
MSG_WARN_PHASE_3_TAKES_10_15_MINUTES="La phase 3 prend de 10 à 15 minutes de téléchargements Docker + Ollama."
...
MSG_FAIL_XCODE_COMMAND_LINE_TOOLS_INSTALL_DID="L'installation des Xcode Command Line Tools ne s'est pas terminée en 10 minutes. Exécutez 'xcode-select --install' manuellement, acceptez la boîte de dialogue, puis relancez ce programme d'installation."
...
MSG_STEP_INSTALLING_THIS_TAKES_A_WHILE="Installation (cela peut prendre un certain temps : n'hésitez pas à vous éloigner)"
