...
progress "Setting up ostler-assistant binary (v${OSTLER_ASSISTANT_VERSION:-0.4.41})" "ostler_assistant"

OSTLER_ASSISTANT_VERSION="${OSTLER_ASSISTANT_VERSION:-0.4.41}"
