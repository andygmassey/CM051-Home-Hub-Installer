...
if [[ "$CHANNEL_WHATSAPP_ENABLED" == true ]]; then
    ...
    echo "  Terms of Service. Ostler reads your messages by linking to"
    echo "  WhatsApp Web as an additional device on this Mac, the same"
    echo "  way the WhatsApp desktop app links. Your messages sync down"
    echo "  to this Mac through WhatsApp's own infrastructure and are"
    echo "  then read locally by Ostler. We never use the official"
    echo "  WhatsApp API. Automating WhatsApp Web this way is not how"
    echo "  WhatsApp's terms say their service should be used, and"
    echo "  counts as \"unofficial\" by their definition."
    echo ""
    ...
    echo -e "  that links to WhatsApp Web as a device on your Mac; we are not a"
