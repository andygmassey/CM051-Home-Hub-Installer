...
echo ""
echo "  To build your knowledge graph, Ostler reads - locally, on this"
echo "  Mac - the records that make up your life. This includes:"
echo ""
echo "    - Your Messages history (iMessage and SMS), from Messages.app."
echo "    - Your Apple Mail."
echo "    - Anything you import from third parties (Google Takeout, Meta"
echo "      downloads, LinkedIn exports)."
echo ""
echo "  These contain information about other people too - emails they"
echo "  sent you, messages they wrote, contact details, calendar"
echo "  attendees. This is normal. It's your inbox, your messages, your"
echo "  life as it actually exists."
echo ""
...
echo "  Your decision:"
echo ""
echo "    [Y] I understand and allow Ostler to read my Messages, Mail"
echo "        and imported data, locally on this Mac. Continue."
echo "    [N] I do not consent. (cancels and removes the installer;"
echo "        nothing is stored on this Mac)"
echo ""
...
services:
  ...
  wiki-site:
    image: ghcr.io/ostler-ai/ostler-wiki-site@sha256:5601129a8ad4a907f50d8e9e1da69ec1beaedb4dcf6b528737d06dc863ada4e9
  ...
  wiki-compiler:
    image: ghcr.io/ostler-ai/ostler-wiki-compiler@sha256:cff6d7e9bda05da5a8a6bcefde0b87c1646a1e71f023b506e497ca27ce374fb9
...
progress "Setting up ostler-assistant binary (v${OSTLER_ASSISTANT_VERSION:-0.4.21})" "ostler_assistant"

OSTLER_ASSISTANT_VERSION="${OSTLER_ASSISTANT_VERSION:-0.4.21}"
