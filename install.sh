...
services:
  ...
  wiki-compiler:
    image: ghcr.io/ostler-ai/ostler-wiki-compiler@sha256:cc0226a411a29601a380f45defd3f45f7ed0e22f3fed1be942732d519effca71
...
OSTLER_ASSISTANT_VERSION="${OSTLER_ASSISTANT_VERSION:-0.4.14}"
