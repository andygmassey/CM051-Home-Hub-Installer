...
services:
  ...
  wiki-compiler:
    image: ghcr.io/ostler-ai/ostler-wiki-compiler@sha256:86947c0b69946966120592fbf82325c73f033bdc0219517c9ecc10199347dc13
...
progress "Setting up ostler-assistant binary (v${OSTLER_ASSISTANT_VERSION:-0.4.35})" "ostler_assistant"

OSTLER_ASSISTANT_VERSION="${OSTLER_ASSISTANT_VERSION:-0.4.35}"
