...
services:
  ...
  wiki-site:
    image: ghcr.io/ostler-ai/ostler-wiki-site@sha256:303b3a1a164720cfbc39da5d9380c98ebde89b32600ce4653e4b02b800194a81
  ...
  wiki-compiler:
    image: ghcr.io/ostler-ai/ostler-wiki-compiler@sha256:a7e8c7e8151e8e559ddefb8f6fb463b0ed25469ea42d74ffa9ccd74c7e032923
...
<dict>
    ...
    <dict>
        ...
        <string>/api/safari/ingest,/api/v1/hub/health,/api/v1/timeline,/api/v1/people,/api/v1/people/search,/api/v1/people/context,/api/v1/person/{slug}/timeline,/api/v1/people/stale,/api/v1/people/recent,/api/v1/people/birthdays,/api/v1/suggestions,/api/v1/calendar,/api/v1/calendar/today,/api/v1/conversation/process,/api/v1/conversation/status/{id},/api/v1/email/recent,/api/v1/ingest/ios,/api/v1/health/day,/api/v1/recording/active,/api/v1/coach/recent,/api/v1/people/{slug}/forget,/api/v1/hydration/status</string>
...
progress "Setting up ostler-assistant binary (v${OSTLER_ASSISTANT_VERSION:-0.4.36})" "ostler_assistant"

OSTLER_ASSISTANT_VERSION="${OSTLER_ASSISTANT_VERSION:-0.4.36}"
