...
# Show notification
osascript -e "display notification \"${#FOUND[@]} data export(s) found in Downloads. Open Terminal and run: ostler-import ~/Downloads/\" with title \"Lifeline\" subtitle \"GDPR exports ready to import\""
...
echo "    - Lifeline directory (~/.ostler, except power.conf)"
