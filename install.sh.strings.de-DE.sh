...
MSG_STEP_SETUP_ANSWER_FEW_QUESTIONS_THEN_WALK="Einrichtung (beantworten Sie ein paar Fragen, dann können Sie gehen)"
...
MSG_INFO_CLT_STILL_INSTALLING_ELAPSED="  Es wird weiterhin auf die Command Line Tools gewartet (vergangen: %ss)..."
...
MSG_INFO_THIS_MAY_TAKE_5_15_MINUTES="Dies kann je nach Datenmenge 5-15 Minuten dauern..."
...
MSG_OK_POWER_SOURCE_AC_GOOD_10_15="Stromquelle: Netzbetrieb (gut für die 10-15-minütige Installation)"
...
MSG_WARN_BLOCK_3_1_CM024_PRODUCTISATION_STACK="Block 3.1 des Produktivierungs-Stacks für den Knowledge-Dienst fügt pyproject.toml hinzu…"
...
MSG_WARN_HEALTH_CHECK_FAILED_PWG_CONVO_HELP="  Funktionsprüfung fehlgeschlagen: pwg-convo --help wurde nicht sauber zurückgegeben."
...
MSG_WARN_PHASE_3_TAKES_10_15_MINUTES="Phase 3 dauert 10-15 Minuten für Docker- + Ollama-Downloads."
...
MSG_FAIL_XCODE_COMMAND_LINE_TOOLS_INSTALL_DID="Die Installation der Xcode Command Line Tools wurde nicht innerhalb von 10 Minuten abgeschlossen. Führen Sie 'xcode-select --install' manuell aus, bestätigen Sie den Dialog und führen Sie diesen Installer dann erneut aus."
...
MSG_STEP_INSTALLING_THIS_TAKES_A_WHILE="Installation (das kann eine Weile dauern – Sie können gerne weggehen)"
