...
MSG_STEP_SETUP_ANSWER_FEW_QUESTIONS_THEN_WALK="Configuración (responde unas preguntas y luego puedes irte)"
...
MSG_INFO_CLT_STILL_INSTALLING_ELAPSED="  Sigo esperando a las Herramientas de Línea de Comandos (transcurrido: %ss)..."
...
MSG_INFO_THIS_MAY_TAKE_5_15_MINUTES="Esto puede tardar de 5 a 15 minutos según la cantidad de datos que tengas..."
...
MSG_OK_POWER_SOURCE_AC_GOOD_10_15="Fuente de energía: CA (buena para la instalación de 10 a 15 minutos)"
...
MSG_WARN_BLOCK_3_1_CM024_PRODUCTISATION_STACK="El bloque 3.1 de la pila de productización del servicio de conocimiento añade pyproject.toml…"
...
MSG_WARN_HEALTH_CHECK_FAILED_PWG_CONVO_HELP="  Comprobación de estado fallida: pwg-convo --help no devolvió correctamente."
...
MSG_WARN_PHASE_3_TAKES_10_15_MINUTES="La fase 3 tarda de 10 a 15 minutos de descargas de Docker + Ollama."
...
MSG_FAIL_XCODE_COMMAND_LINE_TOOLS_INSTALL_DID="La instalación de las Herramientas de Línea de Comandos de Xcode no se completó en 10 minutos. Ejecuta 'xcode-select --install' manualmente, acepta el diálogo y luego vuelve a ejecutar este instalador."
...
MSG_STEP_INSTALLING_THIS_TAKES_A_WHILE="Instalando (esto puede tardar un rato: puedes irte tranquilamente)"
