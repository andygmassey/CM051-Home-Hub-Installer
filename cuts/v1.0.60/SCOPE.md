...
| G5 | Probe (E1) and walk READ this artefact rather than re-implementing | TODO — **IN BUILD (A2, sequenced by Archie 2026-09-02T19:45Z)** | one artefact, three readers. Taken together with E1 because a probe that READS the endpoint proves the artefact is USED, not merely served, and because store-derived probes cannot see the "two empty stores agreeing on zero" case the record exists to expose |
