...
def main():
    # Validate required env vars at entry point. CardDAV is optional
    # here (enrichment only -- gated by --enrich-contacts) so the
    # pair-coupling check still runs but require_carddav is False.
