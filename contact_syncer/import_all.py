...
def main():
    # Validate the always-on pair-coupling rule at entry point.
    # Per-platform parsers we delegate to declare their own
    # `require_*` flags. Audit ref
    # /tmp/silent_fail_audit_2026-05-04.md HIGH-4.
    ...
    parser.add_argument("--user-name", type=str, default="User",
                        help="Your name as it appears in platform exports (for sender matching)")
