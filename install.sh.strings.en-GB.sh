...
MSG_INFO_INTEREST_PROFILE_BUNDLED="Interest-profile compiler bundled with installer; using vendored source."
MSG_INFO_INTEREST_PROFILE_SOURCE_NOT_BUNDLED="Interest-profile compiler not bundled; skipping (set PWG_CM059_REPO to enable)."
MSG_WARN_INTEREST_PROFILE_CLONE_FAILED="Interest-profile compiler clone failed; skipping the preferences artefact."
MSG_OK_INTEREST_PROFILE_WRITTEN="Interest profile compiled: %s"
MSG_WARN_INTEREST_PROFILE_EMPTY="Interest profile compiled but empty (no preferences in the graph yet)."
MSG_WARN_INTEREST_PROFILE_EMIT_FAILED="Interest-profile emit failed; the preferences answer stays unavailable until re-run."
