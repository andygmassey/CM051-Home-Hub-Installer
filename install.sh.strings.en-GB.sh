...
MSG_INFO_SUBSCRIPTION_PRICING_HINT="Ostler Pro is GBP 9.99 per month after the trial. Subscribe via the iOS Companion app."
...
MSG_INFO_IMESSAGE_BRIDGE_STARTED="Setting up iMessage bridge LaunchAgent (assistant-user reply path)"
