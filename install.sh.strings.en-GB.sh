...
MSG_INFO_IMESSAGE_FDA_ASSIST_OPENING="Opening System Settings to walk you through granting Full Disk Access to the assistant..."
MSG_INFO_ASSISTANT_DAEMON_PREWARN="Starting the assistant so macOS can ask for Messages access before we set up Full Disk Access..."
MSG_PROMPT_ASSISTANT_DAEMON_PREWARN_TITLE="Next: allow Ostler to read your Messages"
MSG_PROMPT_ASSISTANT_DAEMON_PREWARN_LINE1="In a moment macOS will ask Ostler for permission to read your Messages."
MSG_PROMPT_ASSISTANT_DAEMON_PREWARN_LINE2="Click Allow on the macOS prompt. Then we will help you switch on Full Disk Access."
MSG_PROMPT_ASSISTANT_DAEMON_PREWARN_BUTTON="Continue"
MSG_WARN_ASSISTANT_DAEMON_BOOTSTRAP_DEFERRED_FAILED="Could not start the assistant background service. It will start automatically next time you log in. Run the Doctor dashboard if Ostler does not respond."
...
MSG_OK_EDITOR_FRONTPAGE_AGENT_INSTALLED="The Editor Front Page will refresh every hour."
MSG_WARN_EDITOR_FRONTPAGE_PLIST_LOAD_FAILED="Could not start the Editor Front Page refresh agent. The Front Page will still rebuild on the next recompile."
MSG_INFO_EDITOR_FRONTPAGE_STAGING="Setting up the Editor Front Page at %s..."
MSG_WARN_EDITOR_FRONTPAGE_STAGING_FAILED="Could not stage the Editor Front Page sources. The Front Page will be unavailable until the next install."
...
MSG_PROMPT_IMESSAGE_FDA_ASSIST_LINE2="Find \"Ostler\" in the list and turn it on."
