...
MSG_WARN_GB_RAM_DETECTED_WORKS_BUT_LIMITS="%s GB RAM detected. You'll run gemma4:e2b – a fast, light model that handles everyday assistant work well. 24 GB+ unlocks our larger model (qwen3.5:9b) with stronger tool-calling for complex requests."
