...
MSG_INFO_ICAL_SERVER_SOURCE_NOT_BUNDLED="Assistant API source not bundled; the endpoints the Ostler app on your iPhone uses will be limited."
...
MSG_WARN_ICAL_SERVER_FAILED="Could not start Assistant API; the endpoints the Ostler app on your iPhone uses will be limited until the next install run."
...
MSG_FAIL_ARCH_INTEL_NOT_SUPPORTED_V1_0="Intel Macs are not supported. Apple Silicon (M1, M2, M3 or M4) is required."
