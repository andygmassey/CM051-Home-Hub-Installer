...
MSG_OK_DATABASES_ENCRYPTED_TOUCH_ID_REQUIRED_EACH_STARTUP="Databases encrypted. Passphrase required at each startup."
...
MSG_OK_TOUCH_ID_BRIEFING_ACKNOWLEDGED="Passphrase briefing acknowledged."
...
MSG_PROMPT_RECOVERY_PASSPHRASE_OPT_IN_HELP="Deprecated in v1.0: passphrase is always required."
