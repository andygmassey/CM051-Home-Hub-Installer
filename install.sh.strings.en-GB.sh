...
MSG_OK_RELEASE_MANIFEST_WRITTEN="Release manifest written (~/.ostler/ostler-release.json -- queryable from Doctor)"
MSG_INFO_RELEASE_MANIFEST_DEFERRED="Release manifest could not be written this run; Doctor will show version as unknown until the next install."
