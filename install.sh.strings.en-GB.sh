...
MSG_WARN_WIKI_TAILNET_FUNNEL_ON="Tailscale Funnel is switched on for this machine. Funnel publishes to the open internet; your wiki refuses Funnel traffic, but you should turn Funnel off unless you meant to enable it."
