...
MSG_WARN_PHASE_3_TAKES_10_15_MINUTES="Phase 3 typically takes 20-40 minutes (Docker + Ollama downloads + first-time setup), and can be longer on a slower connection."
