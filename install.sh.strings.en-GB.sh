...
MSG_ERR_PORT_PREFLIGHT_CANNOT_RUN_ABORT="Ostler could not confirm those ports are free, and it will not start its databases on a port it has not checked. Please contact support@ostler.ai with your install log."
