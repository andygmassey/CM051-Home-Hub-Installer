# VENDORED FROM https://github.com/andygmassey/HR015-Gaming-PC/blob/3a69c6c6db707791a1b7e6bdafdd690d37fa475f/ostler_fda/usage_journal.py
#
# DO NOT EDIT THIS FILE. Its fix direction is UPSTREAM: change HR015
# ostler_fda/usage_journal.py, then re-vendor. A local edit here is caught by
# tests/test_usage_journal_vendor_drift.py, which pins the sha256 of every
# line BELOW this banner:
#
#   body sha256 27cae1e3c764dc4f7cbcd06b7355a557c7e9638a4c2abbbc4dfd26053400bc5e
#
# Vendored rather than depended on because HR015 is PRIVATE: CM048's CI
# GITHUB_TOKEN cannot check it out, which is the same constraint that kept
# 35 of this repo's 36 test files dark until 2026-08-23 (see tests.yml).
